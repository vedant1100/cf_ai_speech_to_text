...
// src/workflow.ts
var SYSTEM_INSTRUCTION = `You are a helpful, concise voice assistant. Respond naturally as if speaking aloud.
Keep answers brief and clear \u2014 aim for 1-3 sentences unless the user asks for detail.`;
async function runChatWorkflow(input) {
...
__name(runChatWorkflow, "runChatWorkflow");

// src/durable-object.ts
import { DurableObject } from "cloudflare:workers";
var ChatSession2 = class extends DurableObject {
  static {
    __name(this, "ChatSession");
  }
  messages = [];
...
// .wrangler/tmp/bundle-ERlkj5/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-ERlkj5/middleware-loader.entry.ts
